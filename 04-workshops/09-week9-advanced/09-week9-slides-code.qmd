...
1.  Questions on Homework
  - Updated link for PS4 (Sorry, GitHub changed how it does raw links during the course of this class, which has been creating mess; earlier PS's and materials use the old, while newer ones use the new) 
  - NO PS5 
  - All keys posted as of class time 
2.  Git/GitHub
3.  Parallelization using `future`
4.  `furrr`

## [Course Evaluations]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}

- Please fill out your course evaluations! 
- I will send a separate eval with the opportunity to give more feedback on specific topics included (or not included) 
- Formal course evals are important for: 

    * Merit / promotion 
    * Course prioritization 
    * TA allocation 

## [What and why use Git and GitHub?]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [What is **version control**?]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [How version control works:]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [Why use Git and GitHub?]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [What is **Git**? (from git [[website](https://git-scm.com/)]{style="color:white;"})]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%" .smaller}
...
## [What is a **Git repository**?]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
-   This course is a Git repository ([PSC203a WQ26 repository](https://github.com/emoriebeck/psc203a-data-WQ26/))
...
## [Private vs. public repositories]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}

-   **Public repositories**: anyone can access the repository
    -   e.g., [PSC203A WQ26](https://github.com/emoriebeck/psc203a-data-WQ26/), the git repository we created to develop the course is a public repository because I want the public to benefit from this course (and for you to access it for a long time)
-   **Private repositories**: only those who have been granted access by a repository "administrator" can access the repository

## [What is **GitHub**?]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Git Workflow]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%" .smaller}
...
## [Git Workflow]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [What is a **commit**?]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [Three components of a Git project]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Three components of a Git project]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%" .smaller}

1.  [**Local working directory**]{style="color:#cc0000;"} (also called "working tree")
...
2.  [**Git index/staging area**]{style="color:#cc7a00;"} (`git add <filename(s)>` command)
...
3.  [**Repository**]{style="color:#009999;"} (`git commit` command)
...
## [GitHub Desktop]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [Exercise: Setting Up GitHub Desktop]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [The basic workflow]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%" .smaller}
...
## [Cloning]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Exercise]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Work on the files]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Staging your files]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}

![Stage your file](https://raw.githubusercontent.com/walice/git-tutorial/master/assets/staged-file.png)

## [Commit your changes]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Push your changes]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Why Use Git/Hub]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Some Last Notes: Branching]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}

- Branching is a useful feature for collaboration in Git. 
- Say that both a collaborator and I want to work on the project, we can pull a current copy to a branch and work on it there and then merge back to the main branch. 
- This avoids issues with accidental "saving over" 

:::: fragment 

```{r, echo = F, fig.align='center'}
knitr::include_graphics("images/git-branches-merge.png")
```
...
- This also allows you to have parallel branches for different purposes. 
- For example, most of my repos have a `gh-pages` branch where I source front-facing web content that is available as a standalone webpage using GitHub Pages ([username].github.io/[repo]) 
- These slides and this course website are built via quarto and hosted for free indefinitely on GitHub! 
- Quickstart guide on hosting on GitHub pages [here](https://docs.github.com/en/pages/quickstart). 


# Parallel Processing in R {background-color="blue"}

## [Guarding your resources]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Cleaning up your environment]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%" .smaller}
...
## [Parallel Processing]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
-   This just means that they are using one of many available packages / tools to speed up the estimation of whatever your function is doing


# The future package {background-color="#c00000"}

## [Why use `future` for parallelization?]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%" .smaller}
...
## [Three atomic building blocks]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Anatomy of `future()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%" .smaller}
...
## [Anatomy of `value()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Benefits of future:]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
z <- sd(x) ## Do other things

v <- value(f1) + value(f2); v ## ready after ~5 secs
plan(sequential)
```

## [Setting up your future backend]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Parallel backends]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Workers]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [Globals]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mint-top.png" background-size="100%"}
...
## [Packages]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/purple-top.png" background-size="100%"}
...
# `furrr`: `future` + `purrr` {background-color="#016295"}

> [The goal of furrr is to combine purrr’s family of mapping functions with future’s parallel processing capabilities. The result is near drop in replacements for purrr functions such as map() and map2_dbl(), which can be replaced with their furrr equivalents of future_map() and future_map2_dbl() to map in parallel.]{style="color:white;"}

## [`furrr`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
-   I personally use `furrr` frequently when I need to a bunch of stuff in parallel but not so much I find myself needing to reach for an HPC
  * It's even useful for simpler tasks, like loading in data or model results, creating large numbers of tables and figures, etc.!
...
## [Exercise]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%" .smaller}
...
## [Caution: Data transfer]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
-   Better alternative: don't export large objects using `furrr` but save the output to a local environment that can be loaded in later (e.g., GitHub, SFTP, etc.)

# Last Word  {background-color="black"} 

- [Some last notes will be posted in the next week to pick up some loose ends.]{style="color:white;"} 
- [Thank you for a great quarter!]{style="color:white;"}
