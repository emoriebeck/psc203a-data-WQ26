...
format: 
  revealjs:
    ...
    width: 1400
    # height: 900
    footer: "PSC 203A - Data Cleaning and Management WQ26"
...
-   Seeing colleagues struggle with workflow and data management while working on large-scale coordinated data analyses during my postdoc cemented that even top grad students were not getting that training
...
-   I spent postdoc writing functions and changing how the CDAs my lab was doing were conducted

-   I've spent my time as faculty finding ways to teach the skills I was never taught, updated with the lessons from teaching both this class and 203B as well as mentoring my own students and postdocs

-   This class let's me bring all these together, along with what I've learned about project management
...
[Source](https://nowiknow.com/excel-has-bad-genes/)

## Why You? {.smaller}

### Another Example:

-   The Health and Retirement Study is a huge representative longitudinal study of aging in the United States that has been ongoing for over 30 years.
-   It is largely documented via a series of PDFs or antiquated simple html files (and it's one of the better documented studies)
-   For whatever reason, sometimes the rating scales for the **same item** change over time:
    -   Item: "In most ways my life is close to ideal." (From the Satisfaction with Life Scale)
    -   2006: 6 point scale from "Strongly Disagree" to "Strongly Agree" with no neutral anchor
    -   2008-onwards: 7 point scale from "Strongly Disagree" to "Strongly Agree" with a neutral anchor
-   Either trying to remember this or having to look up the response options every time I use the scale is both inefficient and hugely error-prone.
-   A reproducible, reusuable workflow helps the problem.
...
-   All materials (required and optional) are free and online
    ...
    -   [Data Camp](https://www.datacamp.com/groups/shared_links/47a82efe9c4fee59e3ba4592743caa2326d5c091badc782aec969e244e98ab5e): All paid content unlocked
...
-   Particularly in coding, debugging, and building workflows, it would be counterproductive to outright ban the use of AI

-   Yet the goal of this course is both to teach you technical skills and also to teach you critical engagement and insight into your own workflows and patterns

-   Compromise: You are free to use AI in assignments. However, its use will be based on an honor code:

    -   If you choose to use AI in any assignment, please flag that and explain how the AI based solution worked and how that contributed to your learning (broadly construed)

    -   For example: You encounter an error and place your code and the error in ChatGPT and ask it to debug. It provides a working solution, which you then use in your assignment. You would note that you wrote an initial solution and encountered a bug. Briefly explain that bug and the solution ChatGPT provided to signal your understanding of how it works and possibly how that may prevent errors in the future
...
-   Research Workflow:
    -   <div>
        ...
        > The process of conducting research from conceptualization to dissemination
...
-   Efficient Programming (plz stop copy-pasting or assuming chatGPT solutions are efficient)
...
knitr::include_graphics("https://positron.posit.co/assets/images/positron-logo_fullcolor-TM.png")
```
:::
:::::
...
-   All written in and rendered via Quarto
...
-   [Websites](https://quarto.org/docs/reference/projects/websites.html)
...
-   Depending on time, I'll either take us to RStudio and walk you through some steps and tricks hands on
