...
## [Example]{style="color:white;"} {.smaller background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/green-top-sm.png" background-size="100%"}
...
## [README]{style="color:white;"} {.smaller background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top-sm.png" background-size="100%"}
...
## [`mutate_at()` and `summarize_at()`]{style="color:white;"} {.smaller background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top-sm.png" background-size="100%"}
...
## [`mutate_all()` and `summarize_all()`]{style="color:white;"} {.smaller background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top-sm.png" background-size="100%"}
...
## [`mutate_if()` and `summarize_if()`]{style="color:white;"} {.smaller background-color="white" background-image="https://github.com/emoriebeck/psc290-dataviz-WQ25/raw/main/psc290-dataviz-WQ25/03-images/purple-top-sm.png" background-size="100%"}
