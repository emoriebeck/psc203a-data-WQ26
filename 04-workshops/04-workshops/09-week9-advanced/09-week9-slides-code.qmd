...
## [What is **Git**? (from git [website](https://git-scm.com/))]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%" .smaller}
...
-   Public repositories: anyone can access the repository
    -   e.g., [PSC203A WQ23](https://github.com/emoriebeck/psc203a-data-WQ26/), the git repository we created to develop the course is a public repository because I want the public to benefit from this course (and for you to access it for a long time)
