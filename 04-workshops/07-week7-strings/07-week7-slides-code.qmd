...
## [Dataset we will use]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
# String basics {background-color="blue"}

## [String basics]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Creating Strings]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Quotes in quotes]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
# stringr package {background-color="#00674F"}

> ["A consistent, simple and easy to use set of wrappers around the fantastic `stringi` package. All function and argument names (and positions) are consistent, all functions deal with `NA`'s and zero length vectors in the same way, and the output from one function is easy to feed into the input of another."]{style="color:white;"}

[*Credit: stringr [R documentation](https://www.rdocumentation.org/packages/stringr/versions/1.6.0)*]{style="color:white;"}

## [The `stringr` package:]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [`str_length()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Using `str_length()` on string]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [`str_length()` on character vector]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Using `str_length()` on coercible vectors]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Using `str_length()` on dataframe column]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [`str_c()`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/purple-top.png" background-size="100%"}
...
## [Using `str_c()` on one vector]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/purple-top.png" background-size="100%"}
...
## [Using `str_c()` on more than one vector]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/purple-top.png" background-size="100%"}
...
## [`str_sub()`]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mint-top.png" background-size="100%" .smaller}
...
## [Using `str_sub()` to subset strings]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mint-top.png" background-size="100%"}
...
## [Using `str_sub()` to replace strings]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mint-top.png" background-size="100%"}
...
## [Using `str_sub()` on dataframe columns]{style="color:black;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mint-top.png" background-size="100%"}
...
## [Other `stringr` functions]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [`str_to_upper()`: Turn strings to uppercase]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [`str_to_lower()`: Turn strings to lowercase]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [`str_sort()`: Sort character vectors]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [`str_trim()`: Trim whitespace from strings]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [`str_pad()`: Pad strings with character]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
# Regular expression basics {background-color="black"}

## [Example of using **regular expression**:]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Common regular expression patterns:]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}

-   [**Character classes**]{style="color:blue;"}
-   [**Quantifiers**]{style="color:purple;"}
-   [**Anchors**]{style="color:#00674F;"}
-   [**Sets and ranges**]{style="color:#9B1003;"}
-   [**Groups and backreferences**]{style="color:#016295;"}

*Credit: [DaveChild](https://cheatography.com/davechild/cheat-sheets/regular-expressions/) Regular Expression Cheat Sheet*

## [Character classes]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%" .smaller}
...
## [Character classes]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Using `\d` & `\D` to match digits & non-digits]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [KEY POINT WITH REGEX]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Match all non-digit characters]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Match all digit + non-digit patterns]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Match whitespace and non-whitespace]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
::::
:::::::
## [Match all words & non-words]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%"}
...
## [Wrap-Up: Character Classes]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/blue-top.png" background-size="100%" .smaller}
...
## [Quantifiers]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/purple-top.png" background-size="100%"}
...
## [Anchors]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [Using `^` & `$` to match start & end of string]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/green-top.png" background-size="100%"}
...
## [Sets and ranges]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%" .smaller}
...
## [Using `.` as a wildcard]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Using `|` as an OR operator]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Using `[...]`]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
# Dates and times {background-color="#016295"}

> ["Date-time data can be frustrating to work with in R. R commands for date-times are generally unintuitive and change depending on the type of date-time object being used. Moreover, the methods we use with date-times must be robust to time zones, leap days, daylight savings times, and other time related quirks, and R lacks these capabilities in some situations. Lubridate makes it easier to do the things R does with date-times and possible to do the things R does not."]{style="color:white;"}

[*Credit: `lubridate` [documentation](https://lubridate.tidyverse.org/)*]{style="color:white;"}

## [Dates and times]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%".smaller}
...
## [Dates and times]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [Creating date/time objects]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [Creating `POSIXct` objects]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [Creating `Date` object from `chr` or `dbl` input]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [Creating `POSIXct` object from `chr` or `dbl` input]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [Creating `Date` objects from df column]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [Creating `POSIXct` objects from df column]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [date/time objects from individual components]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [`Date` objects from individual components]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [`POSIXct` object from individual components]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [`Date` objects from dataframe columns]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [`POSIXct` objects from dataframe columns]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/mykonos-top.png" background-size="100%"}
...
## [Date/time object components]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Getting date/time components]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Setting date/time components]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [date/time components from df columns]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/black-top.png" background-size="100%"}
...
## [Time spans]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%" .smaller}
...
## [Time spans using `lubridate`: Durations]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
...
## [Working with duration]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%" .smaller}
...
scorpio_duration <- as.duration(scorpio_interval); scorpio_duration

class(scorpio_duration) # The object has class `Duration`
...
## [Working with duration]{style="color:white;"} {background-color="white" background-image="https://github.com/emoriebeck/psc203a-data-WQ26/raw/main/psc203a-data-WQ26/images/red-top.png" background-size="100%"}
