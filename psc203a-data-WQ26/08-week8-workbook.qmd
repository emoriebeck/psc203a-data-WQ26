---
title: "Week 8 (Tables & Figures) Workbook"
...
```{r}
(gsoep <- read_csv("https://github.com/emoriebeck/psc203a-data-WQ26/raw/refs/heads/main/04-workshops/08-week8-tables/week8-data.csv"))
```
...
(gsoep2 <- read_csv("https://github.com/emoriebeck/psc203a-data-WQ26/raw/refs/heads/main/04-workshops/08-week8-tables/week8-data-2.csv") %>%
...
```{r}
load(url("https://github.com/emoriebeck/psc203a-data-WQ26/raw/refs/heads/main/04-workshops/08-week8-tables/gsoep_nested3.RData"))
terms <- tribble(
  ~path,     ~new,
...
```{r, echo = F}
load(url("https://github.com/emoriebeck/psc203a-data-WQ26/raw/refs/heads/main/04-workshops/08-week8-tables/gsoep_nested2.RData"))
```
